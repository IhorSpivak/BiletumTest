...
class MyPastEventAdapter @Inject constructor(): RecyclerView.Adapter<MyPastEventAdapter.MyNotificationViewHolder>(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyNotificationViewHolder =
        MyNotificationViewHolder(parent.inflate(R.layout.my_events_list_event))
